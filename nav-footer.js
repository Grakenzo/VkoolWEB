  ...
  <div class="nav-links">
    ...
    <div class="nav-dropdown" aria-label="Selengkapnya menu">
      ...
      <div class="nav-dropdown-panel cols-1">
        <a class="dd-item" href="${PAGES.artikel}"><div class="dd-icon"><svg viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg></div><div class="dd-text"><span class="dd-title">Artikel</span><span class="dd-sub">Berita &amp; panduan produk</span></div></a>
        <a class="dd-item" href="${PAGES.videos}"><div class="dd-icon"><svg viewBox="0 0 24 24"><polygon points="23 7 16 12 23 17 23 7"/><rect x="1" y="5" width="15" height="14" rx="2"/></svg></div><div class="dd-text"><span class="dd-title">Videos</span><span class="dd-sub">Lihat instalasi &amp; review</span></div></a>
...
<footer class="footer" role="contentinfo">
  <div class="footer-top">
    ...
    <div>
      ...
      ${footerLink('faq','FAQ')}
      <a class="footer-link" href="${PAGES.videos}">Videos</a>
      <a class="footer-link" href="${PAGES.artikel}">Berita &amp; Events</a>
